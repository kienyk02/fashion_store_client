...
import com.example.fashionstoreapp.databinding.ItemShipmentMethodBinding
import com.example.fashionstoreapp.screen.checkout.ShipmentMethodFragment

class ShipmentMethodAdapter(
    private var list: List<ShipmentMethod>,
    private var fragment: ShipmentMethodFragment
) : RecyclerView.Adapter<ShipmentMethodAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemShipmentMethodBinding) :
